...
var mX: number = MIDDLE_SCREEN_W, mY: number = MIDDLE_SCREEN_W;
var projectile_tracker: Projectile[] = [];
...
class Vec2 {
    ...
    mul_immut(n: number): Vec2 {
        return new Vec2(this.x * n, this.y * n)
    }
}

function getDirUnit(from: Vec2, to: Vec2): Vec2 {
...
class Projectile {
    ...
    constructor(starting_pos: Vec2, end_pos: Vec2, damage?: number, color?: string) {
